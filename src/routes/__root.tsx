...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "MediCore HIS — Hospital Command Center" },
      { name: "description", content: "Integrated Hospital Information System: patients, appointments, EHR, lab, pharmacy & billing." },
    ],
    links: [
